...
-- Volcando estructura de base de datos para wallet_db
CREATE DATABASE IF NOT EXISTS `wallet_db` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `wallet_db`;

-- Volcando estructura para tabla wallet_db.auth_user
...
-- Volcando estructura para tabla wallet_db.wallet_balance
...
-- Volcando estructura para tabla wallet_db.wallet_movement
...
-- Volcando estructura para tabla wallet_db.wallet_subscription
